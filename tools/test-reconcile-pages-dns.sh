...
grep -R -q -E 'test-token-never-print|test-zone-never-print' "$work/stdout" "$work/stderr" && fail "no-op must not print credentials"
...
grep -R -q -E 'test-token-never-print|test-zone-never-print' "$work/stdout" "$work/stderr" && fail "missing check must not print credentials"
...
grep -R -q -E 'test-token-never-print|test-zone-never-print' "$work/stdout" "$work/stderr" && fail "create must not print credentials"
...
grep -R -q -E 'test-token-never-print|test-zone-never-print' "$work/stdout" "$work/stderr" && fail "drift check must not print credentials"
...
grep -R -q -E 'test-token-never-print|test-zone-never-print' "$work/stdout" "$work/stderr" && fail "reconcile must not print credentials"
